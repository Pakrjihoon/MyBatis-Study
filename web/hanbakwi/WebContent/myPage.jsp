...
<div id="wrap">
    <div id="wrapBox">
        <div id="profileInfoBox">
            <div id="profile">
                <label for="photoadd"><img src="/profile/<%=loginUser.getProfileImg() %>" width="100px" height="100px"/></label>
                <input type="file" id="photoadd"/>
                <p><%=loginUser.getNickname() %></p>
            </div>
            <p class="address">활동 지역 1 :</p>
        ...
        <div id="buttonBox">
            <div class="myPageBtn" id="bt2"><i class="far fa-envelope"></i></div>
            <div class="myPageBtn" id="bt3"><i class="fas fa-camera"></i></div>
        </div>
        <div id="followBox">
            <a href="#" id="follower">팔로워 12</a>
            <a href="#" id="follow">팔로우 23</a>
        </div>
        <div id="menuBox">
            <ul>
                <li><i class="fas fa-circle"></i> 작성한 여행기</li>
                <li><i class="fas fa-circle "></i> 내가 찾은 명소</li>
                <li><i class="fas fa-circle"></i> 작성한 리뷰</li>
                <li><i class="fas fa-circle"></i> 사전답사 신청내역</li>
                <li><i class="fas fa-circle"></i> 여행 플랜 내역</li>
                <li><i class="fas fa-circle"></i> 펀딩 내역</li>
                <li><i class="fas fa-circle"></i> 북마크 및 좋아요</li>
            </ul>
        </div>
    </div>
    <div id="gradeWrapBox">
        <h3><%=loginUser.getNickname() %> 님의 등급</h3>
        <div id="gradeBox">
            <p id="sum">합계 거리 65km</p>
            <p id="question"><i class="far fa-question-circle"></i></p>
        </div>
        <div id="bar"></div>
        <div id="tierBox">
        <%String tier = loginUser.getuTier(); %>
            <p id="tier"><%switch(tier) { case "B": tier="브론즈"; break;
            case "S": tier="실버"; break; case "G" : tier ="골드"; break; 
            case "P" : tier="플래티넘"; break; case "D" : tier="다이아"; break;} %>
            <%=tier %></p>
            ...
            <div id="tierIng">
                ...
                <div id="tierImg">
                    <label><img src="img/bicycle.gif" width="75px" height="75px">45km</label>
                </div>
        ...
        <div class="contentBox">
            ...
            <div class="bar2"></div>
            <span class="menuBtn">
            <a href="" class="btn2 on" id="bookmark">북마크</a>
            <a href="" class="btn2" id="like">좋아요</a>
        </span>
            <div id="bookmarkList" class="on2">
                <ul>
                    <li class="bookmarkList_li contentlist">
                        <img class="photo" src="img/paris.jpg"/>
                        <span class="text2">북마크리스트 </span>
                        <span class="text3">그들에게 생명을 불어 넣는 것은</span>
                        <i class="fas fa-times removeBookmark"></i>
                    </li>
                    <li class="bookmarkList_li contentlist">
                        <img class="photo" src="img/paris.jpg"/>
                        <span class="text2">북마크리스트 </span>
            ...
            <div id="likeList">
                <ul>
                    <li class="likeList_li contentlist">
                        <img class="photo2" src="img/paris.jpg"/>
                        <span class="text22">라이크리스트 </span>
                        <span class="text33">그들에게 생명을 불어 넣는 것은</span>
                        <i class="fas fa-times removeLike"></i>
                    </li>
                    <li class="likeList_li contentlist">
                        <img class="photo2" src="img/paris.jpg"/>
                        <span class="text22">라이크리스트 </span>
        ...
        <div class="writeReview ">
            ...
            <div id="allWrap">
                <ul>
                    <li class="card_one">
                        <img src="img/jul2.jpg" class="cardPhoto">
        ...
        <div class="findingSight">
            <div id="f_s_Wrapbox">
                <ul class="f_s_reviewTab">
                    <li class="on3"><a href="" class="f_s_myreviewBtn" id="f_s_all">전체</a></li>
            ...
            <div id="f_s_allWrap">
                <ul>
                    <li class="f_s_card_one">
                        <img src="img/jul2.jpg" class="f_s_cardPhoto">
                        <div class="f_s_blah">JMT</div>
                        <div class="f_s_blah">경기도</div>
                        <i class="fas fa-heart"></i><span> 200</span>
                    </li>
                    <li class="f_s_card_two">
                        <img src="img/jul2.jpg" class="f_s_cardPhoto">
                        <div class="f_s_blah">JMT</div>
                        <div class="f_s_blah">경기도</div>
                        <i class="fas fa-heart"></i><span> 200</span>
                    </li>
                    <li class="f_s_card_three">
                        <img src="img/jul2.jpg" class="f_s_cardPhoto">
                        <div class="f_s_blah">JMT</div>
                        <div class="f_s_blah">경기도</div>
                        <i class="fas fa-heart"></i><span> 200</span>
            ...
            <div id="f_s_roomWrap">
                <ul>
                    <li class="f_s_card_one">
                        <img src="img/jul3.jpg" class="f_s_cardPhoto">
                        <div class="f_s_blah">JMT</div>
                        <div class="f_s_blah">경기도</div>
                        <i class="fas fa-heart"></i><span> 200</span>
                    </li>
            ...
            <div id="f_s_restaurentWrap">
                <ul>
                    <li class="f_s_card_one">
                        <img src="img/jul4.jpg" class="f_s_cardPhoto">
                        <div class="f_s_blah">JMT</div>
                        <div class="f_s_blah">경기도</div>
                        <i class="fas fa-heart"></i><span> 200</span>
                    </li>
        ...
        <div class="fundWrap">
            ...
            <span class="menuBtn">
    <a href="" class="btn2 on" id="myFunding">내가 쓴 펀딩</a>
    <a href="" class="btn2" id="mySpon">후원한 펀딩 목록</a>
    <a href="" id="writeFunding"><i class="far fa-plus-square"></i> 펀딩 작성</a>
    </span>
            <select id="order">
                <option>전체보기</option>
            </select>
            <div id="myFundingWrap">
                <div class="List">
                    <ul>
                        <li class="list">
                            <div class="fundPhoto"></div>
                            <div class="fundText2">[진행중] 인제</div>
                            <div class="fundText3">모든 수상레저 즐기자</div>
                            <div class="fundText4">후원금액 : 123,000 (67%)</div>
                            <div class="fundText5">후원 인원 : 50명</div>
                            <div class="deadlinewrap">
                                <p class="deadline">마감까지</br>
                                    7일
                                </p>
                            </div>
                            <div class="text6">2018.12.27</div>
                        </li>
                        <li class="list">
                            <div class="fundPhoto"></div>
                            <div class="fundText2">[진행중] 인제</div>
            ...
            <div id="mySponWrap">
                <div class="List">
                    <ul>
                        <li class="list">
                            <div class="fundPhoto"></div>
                            <div class="fundText2">[진행중] 서울</div>
                            <div class="fundText3">모든 수상레저 즐기자</div>
                            <div class="fundText4">후원금액 : 123,000 (67%)</div>
                            <div class="fundText5">후원 인원 : 50명</div>
                            <div class="deadlinewrap">
        ...
        <div class="preWrap">
            ...
            <span class="menuBtn">
    <a href="" class="btn2 on" id="mywrite">내가 쓴 게시물</a>
    <a href="" class="btn2" id="myrequest">내가 신청한 게시물</a>
    </span>
            <div id="myWriteList">
                <ul>
                    <li class="writeList">
                        <span><i class="fas fa-circle"></i> 가로수길 답사</span>
                        <div class="infoBox">
                            <div class="detail writePhoto"></div>
                            <a href="" class="detail writeNickName" >하나뿐인절미</a>
                            <a href="" class="detail writeBan" ><i class="fas fa-ban"></i>신고하기</a>
                            <a href="" class="detail writeKakao" >오픈카톡</a>
                            <a href="" class="detail writeMessage" >메세지함</a>
                            <a href="" class="detail writeComplete" >답사완료</a>
                        </div>
                    </li>
                </ul>
            </div>
            <div id="applyList">
                <ul>
                    <li class="a_List">코엑스 답사</li>
                    <li class="a_List">가로수길 답사</li>
                    <li class="a_List">가로수길 답사</li>
                    <li class="a_List">가로수길 답사</li>
                </ul>
            </div>
        ...
        <div class="p_Wrap">
            ...
            <div class="preBar"></div>
            <span class="menuBtn">
    <a href="" class="btn2 on" id="p_mywrite">내가 쓴 게시물</a>
    <a href="" class="btn2" id="p_myrequest">내가 신청한 게시물</a>
    </span>
            <div id="p_myWriteList">
                <ul>
                    <li class="p_writeList">
                        <span><i class="fas fa-circle"></i> 가로수길 답사</span>
                        <div class="p_infoBox">
                            <div class="detail p_writePhoto"></div>
                            <a href="" class="detail p_writeNickName" >하나뿐인절미</a>
                            <a href="" class="detail p_writeBan" ><i class="fas fa-ban"></i>신고하기</a>
                            <a href="" class="detail p_writeKakao" >오픈카톡</a>
                            <a href="" class="detail p_writeMessage" >메세지함</a>
                            <a href="" class="detail p_writeSelect" ">채택하기</a>
                            <a href="" class="detail p_writeComplete" >답사완료</a>
                        </div>
                    </li>
                </ul>
            </div>
            <div id="p_applyList">
                <ul>
                    <li class="p_List">코엑스 답사</li>
                    <li class="p_List">가로수길 답사</li>
                    <li class="p_List">가로수길 답사</li>
                    <li class="p_List">가로수길 답사</li>
                </ul>
            </div>
        ...
        <div class="d_wrap">
            ...
            <div class="prebar"></div>
            <span class="menuBtn">
    <a href="" id="writeDiary"><i class="far fa-plus-square"></i> 새 일정 만들기</a>
    </span>
            <select id="d_order">
                <option>전체보기</option>
            </select>
    ...
    <div id="addWorkBoxPopup" style="overflow:scroll">
        <ul id="addContents">
            <li class="selectBox"><a href=""><img src="img/jul.jpg" width="200" height="200"></a></li>
            <li class="selectBox"><a href=""><img src="img/jul.jpg" width="200" height="200"></a></li>
            <li class="selectBox"><a href=""><img src="img/jul.jpg" width="200" height="200"></a></li>
            <li class="selectBox"><a href=""><img src="img/jul.jpg" width="200" height="200"></a></li>
            <li class="selectBox"><a href=""><img src="img/jul.jpg" width="200" height="200"></a></li>
        ...
        <div id="boxPopup">
            <ul id="contents">
                <li class="imgSelectBox"><img src="img/jul.jpg" width="700" height="700"></li>
            </ul>
    ...
    <div id="pre_Wrap">
        <div id="pre_Popup">
            ...
            <button id="pre_Close"><i class="far fa-times-circle"></i></button>
