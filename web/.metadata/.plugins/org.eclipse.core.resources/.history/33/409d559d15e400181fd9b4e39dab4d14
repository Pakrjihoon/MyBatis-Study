...
<div id="registerFormHeader">
    ...
    <div id="registerFormHeaderText">한바퀴 회원가입</div>
</div>
<div id="registerForm">
    <form id="joinForm" action="/register.jsp" method="post">
        <fieldset>
            ...
            <div class="row">
                <label for="gender">성 별</label><br>
                <span id="gender">
					<input type="radio"
                           checked="checked" id="female" name="gender" value="F" checked="checked"/>
            ...
            <div class="row">
                ...
                <span id="phone">
					...
					<input id="phone2" title="3~4글자 숫자만 입력해주세요." class="digit4"
                           placeholder="숫자입력" size="4" maxlength="4" name="phone2"/>
					-
            ...
            <div id="regist">
                <button style="width:100px; height:35px;" class="btn register"  type="submit">회원가입</button>
                <button style="width:100px; height:35px;" class="btn register"  type="button" onclick="location.href='/index.jsp'">돌아가기</button>
            </div>
        </fieldset>
    </form>
</div>
    ...
    <script src="/js/underscore-min.js"></script>
        ...
        $(".delete").click(function (){
            ...
            function init_option(){
                ...
                var area8 = ["고양시","과천시","광명시","광주시","구리시","군포시","김포시","남양주시","동두천시","부천시","성남시","수원시","시흥시","세종시","안산시","안성시","안양시","양주시","오산시","용인시","의왕시","의정부시","이천시","파주시","평택시","포천시","하남시","화성시","가평군","양평군","여주군","연천군"];
            ...
            $(".row").on("click","#addBtn",function (e) {
                e.preventDefault();
                $(".row2").eq($(this).index()).after(
                    '<div class="row2">\n' +
